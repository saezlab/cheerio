...
magnet= readRDS("../cheerio_data/raw_data/magnet/contrast_list.rds")
...
x1= read_csv("../cheerio_data/raw_data/invitro_PE/Ribo_DEG_CPM10_NRVM_online.csv")
x2= read_csv("../cheerio_data/raw_data/invitro_PE/RNA_DEG_CPM10_NRVM_online.csv")
...
## proteome
rat_prot= read_csv("../cheerio_data/raw_data/proteome/Rat_invitro/Limma_results_V1 PE vs Ctrl in vitro Kardios.csv" ,
                   skip = 1)
rat_prot<- rat_prot %>%
...
swim_prot= read_csv("../cheerio_data/raw_data/proteome/Maus Swim/Limma_results_V2.csv")
swim_prot <- swim_prot %>% 
...
tac_prot= read_csv("../cheerio_data/raw_data/proteome/Maus TAC/Limma_results_V1.csv")
tac_prot <- tac_prot %>% 
...
hs_prot= read_csv("../cheerio_data/raw_data/proteome/Human Prosser Paper/Limma_results_V1.csv")
...
joint_contrast_df = 
  ...
  dplyr::select(-min_FDR, -gene_rank)%>% 
  ungroup()
